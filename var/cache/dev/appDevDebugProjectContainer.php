...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'user_extension' => 'getUserExtensionService',
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter(($this->targetDirs[3].'\\app/Resources/java/yuicompressor.jar'), 'C:\\Program Files\\Java\\jdk1.8.0_65\\bin\\java.exe');
    ...
    {
        return $this->services['assetic.filter_manager'] = new \Symfony\Bundle\AsseticBundle\FilterManager($this, array('cssrewrite' => 'assetic.filter.cssrewrite', 'cssembed' => 'assetic.filter.cssembed', 'yui_js' => 'assetic.filter.yui_js', 'yui_css' => 'assetic.filter.yui_css', 'lessphp' => 'assetic.filter.lessphp'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'AssoGolf', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\TournamentBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'TournamentBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('TournamentBundle' => 'TournamentBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_ced2c112cc20d803e885e994828ea2d36dda4e7c60384f8371d1126bd232faf0');
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k->add($j, array(0 => 'ROLE_ORGANIZER'), NULL);

        $l = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $l, $this->get('redirect.after.logout'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $m->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $n = new \Divi\AjaxLoginBundle\Security\Http\Authentication\AjaxAuthenticationSuccessHandler($l, array('login_path' => '/', 'always_use_default_target_path' => true, 'default_target_path' => '/', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $n->setProviderKey('main');

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($k, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username')), 'main', $a, $c), 2 => $m, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $l, 'main', $n, new \Divi\AjaxLoginBundle\Security\Http\Authentication\AjaxAuthenticationFailureHandler($e, $l, array('login_path' => '/', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a, $this->get('translator'), $e, $l, array(), $this->get('logger', ContainerInterface::NULL_ON_INVALID_REFERENCE)), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '570f69301beae4.16614535', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $k, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $l, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $l, '/', false), NULL, NULL, $a, false));
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('user_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\TournamentBundle/Resources/views'), 'Tournament');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b4956501c807f405e6159af11d2e9b3c7fd358af');
    }

    /**
     * Gets the 'user_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \UserBundle\Twig\UserExtension A UserBundle\Twig\UserExtension instance.
     */
    protected function getUserExtensionService()
    {
        return $this->services['user_extension'] = new \UserBundle\Twig\UserExtension();
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ORGANIZER' => array(0 => 'ROLE_USER')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TournamentBundle' => 'TournamentBundle\\TournamentBundle',
            ...
            'secret' => 'b4956501c807f405e6159af11d2e9b3c7fd358af',
            'locale' => 'fr',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'b4956501c807f405e6159af11d2e9b3c7fd358af',
            ...
            'assetic.filter.cssembed.jar' => ($this->targetDirs[3].'\\app/Resources/java/cssembed.jar'),
            ...
            'assetic.filter.yui_js.java' => 'C:\\Program Files\\Java\\jdk1.8.0_65\\bin\\java.exe',
            'assetic.filter.yui_js.jar' => ($this->targetDirs[3].'\\app/Resources/java/yuicompressor.jar'),
            ...
            'assetic.filter.yui_css.jar' => ($this->targetDirs[3].'\\app/Resources/java/yuicompressor.jar'),
